...
public class Fonts {
    ...
    void setFonts(PApplet p5){
        ...
        this.fonts[0] = p5.createFont("data/StickySugary.ttf", midaTitol);
        this.fonts[1] = p5.createFont("data/Grandiosity-Regular.ttf", midaSubtitol);
        this.fonts[2] = p5.createFont("data/Timeless.ttf", midaParagraf);
    }
